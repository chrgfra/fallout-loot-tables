...
export const armor = [
  ...
  { name: 'Light Dog Armor', rarity: 1, source: 'Core, 123' },
  { name: 'Medium Dog Armor', rarity: 2, source: 'Core, 123' },
  { name: 'Heavy Dog Armor', rarity: 3, source: 'Core, 123' },
  // armor pieces
  { name: 'Raider Armor Piece', rarity: 0, source: 'Core, 130' },
  { name: 'Sturdy Raider Armor Piece', rarity: 1, source: 'Core, 130' },
  { name: 'Heavy Raider Armor Piece', rarity: 2, source: 'Core, 130' },
  { name: 'Leather Armor Piece', rarity: 1, source: 'Core, 130' },
  { name: 'Sturdy Leather Armor Piece', rarity: 2, source: 'Core, 130' },
  { name: 'Heavy Leather Armor Piece', rarity: 3, source: 'Core, 130' },
  { name: 'Metal Armor Piece', rarity: 1, source: 'Core, 131' },
  { name: 'Sturdy Metal Armor Piece', rarity: 2, source: 'Core, 131' },
  { name: 'Heavy Metal Armor Piece', rarity: 3, source: 'Core, 131' },
  { name: 'Combat Armor Piece', rarity: 2, source: 'Core, 131' },
  { name: 'Study Combat Armor Piece', rarity: 3, source: 'Core, 131' },
  { name: 'Heavy Combat Armor Piece', rarity: 4, source: 'Core, 131' },
  { name: 'Synth Armor Piece', rarity: 3, source: 'Core, 132' },
  { name: 'Sturdy Synth Armor Piece', rarity: 4, source: 'Core, 132' },
  { name: 'Heavy Synth Armor Piece', rarity: 5, source: 'Core, 132' },
  { name: 'Vault-Tec Security Helmet Piece', rarity: 1, source: 'Core, 132' },
  { name: 'Vault-Tec Security Armor Piece', rarity: 1, source: 'Core, 132' },
  { name: 'Legionary Recruit Armor Piece', rarity: 3, source: 'Wanderers, 89' },
  { name: 'Legionary Armor Piece', rarity: 4, source: 'Wanderers, 89' },
  { name: 'Legionary Centurion Armor Piece', rarity: 5, source: 'Wanderers, 89' },
  { name: 'Marine Armor Piece', rarity: 4, source: 'Wanderers, 90' },
  { name: 'Scout Armor Piece', rarity: 4, source: 'Wanderers, 91' },
  { name: 'Robot Armor Piece', rarity: 2, source: 'Wanderers, 92' },
  { name: 'Sturdy Robot Armor Piece', rarity: 3, source: 'Wanderers, 92' },
  { name: 'Heavy Robot Armor Piece', rarity: 4, source: 'Wanderers, 92' },
